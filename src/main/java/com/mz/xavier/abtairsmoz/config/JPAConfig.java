 ...
 */
@Configuration
@EnableJpaRepositories(basePackageClasses = ActorTypes.class)
@ComponentScan(basePackageClasses = ActorTypes.class)
...
public class JPAConfig {
	...
	public DataSource dataSource(){
		...
		return dataSourceLookup.getDataSource("jdbc/mozirsDB");
	}
